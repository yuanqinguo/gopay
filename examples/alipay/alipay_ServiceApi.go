...
import (
	...
	"github.com/yuanqinguo/gopay/alipay"
	"github.com/yuanqinguo/gopay/pkg/xlog"
	"github.com/yuanqinguo/gopay/pkg/xrsa"
)
...
func SystemOauthToken2() {
	...
	rsp, err := alipay.SystemOauthToken("2016091200494382", privateKey, "", "06e8961891d647c0ac99bb1cebe7SE69", alipay.RSA2)
	if err != nil {
